...
function wordbee_api_plugin_register_settings() {
    // Register settings
    register_setting('wordbee-api-plugin-settings-group', 'wordbee_api_key');
    register_setting('wordbee-api-plugin-settings-group', 'wordbee_username');
}
    ...
    <form method="post" action="options.php">
        ...
        <table class="form-table">
            <tr valign="top">
                ...
                <td><input type="text" name="wordbee_api_key" value="<?php echo esc_attr(get_option('wordbee_api_key')); ?>" /></td>
            </tr>
             
            <tr valign="top">
                <th scope="row">Username</th>
                <td><input type="text" name="wordbee_username" value="<?php echo esc_attr(get_option('wordbee_username')); ?>" /></td>
            </tr>
        </table>
